<?php
   ...
   session_start();
   $user_id = $_SESSION['id'];
   $cn_problem_id = intval($_GET['id']);
   $db = new Database();
   $cn_solutions = $db->get_problem_by_id("contest_problems",$cn_problem_id);
   $contest_id = $cn_solutions['contest_id'];
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class='row' style="margin-bottom: 15px;">
                        <div class="col-md-6">
                           <a href="contest_problems.php?contest_id=<?=$contest_id?>" class="btn btn-default">
                        ...
                        <div class="col-md-12">
                            <div class="white_shd full margin_bottom_30">
                                ...
                                <div class="problem-header">
                                    <div class="problem-title">Masala #<?= str_pad($cn_solutions['id'], 4, '0', STR_PAD_LEFT) ?></div>
                                    <div class="problem-meta">
                                        <div class="meta-item"><strong>Xotira:</strong> <?=intval($cn_solutions['memory_limit']/1024) ?> MB</div>
                                        <div class="meta-item"><strong>Vaqt:</strong> <?=$cn_solutions['time_limit'] ?> ms</div>
                                        <div class="meta-item">
                                            <strong>Qiyinchiligi:</strong> 
                                            <span class="difficulty-badge difficulty-easy"><?=$cn_solutions['difficulty'] ?></span>
                                        </div>
                                    </div>
                                    <div class="rating-section">
                                        <span class="category-badge">#<?=$cn_solutions['category'] ?></span>
                                    ...
                                    <div class="author-info">
                                        Muallif: <?=$cn_solutions['author_name'] ?>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content" id="problemTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="problem" role="tabpanel">
                                        <div class="problem-description">
                                            <h3 style="color: #2c3e50; margin-bottom: 20px;"><?=$cn_solutions['title'] ?></h3>
                                            
                                            <p><?=$cn_solutions['descript'] ?></p>
                                            <div class="io-section">
                                                <h4 class="io-title">Kiruvchi ma'lumotlar:</h4>
                                                <p>INPUT.TXT kirish ma'lumot: <?=$cn_solutions['input_format'] ?></p>
                                            </div>
                                            <div class="io-section">
                                                <h4 class="io-title">Chiquvchi ma'lumotlar:</h4>
                                                <p>OUTPUT.TXT chiqish ma'lumot: <?=$cn_solutions['output_format'] ?></p>
                                            </div>
                                            ...
                                            <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin: 20px 0;">
                                                ...
                                                <div class="example-content" style="margin-top: 10px;"><?=$cn_solutions['izoh'] ?></div>
                                            </div>
                                            <form id="attemptForm" onsubmit="submitAttempt(event)">
                                                <input type="hidden" name="user_id" value="<?= $cn_solutions['user_id']; ?>">
                                                <input type="hidden" name="problem_id" value="<?= $cn_problem_id; ?>">
                                                ...
                                                <div class="code-editor">
                                                    ...
                                                    <div class="editor-footer">
                                                        ...
                                                        <div class="editor-actions">
                                                            <button type="button" class="editor-btn secondary">
