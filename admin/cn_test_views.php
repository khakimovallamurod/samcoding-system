<?php
    ...
    // Get test cases
    $cn_tests = $db->get_data_by_table_all('contest_tests', "Where cn_problem_id = $cn_problem_id");
?>
<html lang="en">
                        ...
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>
                                  ...
                                  Test Cases - <?= htmlspecialchars($cn_problem['title']) ?>
                              </h2>
                           </div>
                        </div>
                     </div>
                            ...
                            <div class="white_shd full margin_bottom_30">
                                ...
                                <div class="full price_table padding_infor_info">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php else: ?>
                                                    <?php foreach ($cn_tests as $index => $test): ?>
                                    ...
                                    <div class="add-test-section">
                                        ...
                                        <form id="addTestForm">
                                            <input type="hidden" name="cn_problem_id" value="<?= $cn_problem_id ?>">
                                            <div class="row">
                                                <div class="col-md-6">
